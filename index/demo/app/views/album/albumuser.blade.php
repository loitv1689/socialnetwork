...
@endsection
        ...
        @section('album')
                    ...
                    <div class="content"> 
						...
						?>								
								<div class="lyteboximage"><a href="<?php echo $value->url_image; ?>" class="lytebox" data-lyte-options="group:vacation" data-title=""><img src="<?php echo $value->url_image; ?>"/></a><span class="clear_fix_both"></span></div>
						<?php								
								}
							}
						?>
